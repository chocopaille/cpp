...
Personnage::Personnage() : m_life(100), m_mana(100), m_weapon(0)
{
	m_weapon = new Weapon();
}
Personnage::Personnage(std::string weapon_name, int damage_weapon) : m_life(100), m_mana(100), m_weapon(0)
{
	m_weapon = new Weapon(weapon_name, damage_weapon);
}
